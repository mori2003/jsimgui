...
export class ImNodes {
	...
	static DestroyContext(ctx: ImNodesContext | null = null): void {
	 ...
	 */
	static StyleColorsDark(dest: ImNodesStyle | null = null): void {
		Mod.export.ImNodes_StyleColorsDark(dest?.ptr ?? null);
	}

	static StyleColorsClassic(dest: ImNodesStyle | null = null): void {
		Mod.export.ImNodes_StyleColorsClassic(dest?.ptr ?? null);
	}

	static StyleColorsLight(dest: ImNodesStyle | null = null): void {
	 ...
	 */
	static MiniMap(minimap_size_fraction: number = 0.2, location: ImNodesMiniMapLocation = 2): void {
	 ...
	 */
	static BeginInputAttribute(id: number, shape: ImNodesPinShape = 1): void {
	 ...
	 */
	static BeginOutputAttribute(id: number, shape: ImNodesPinShape = 1): void {
	 ...
	 */
	static IsAnyAttributeActive(attribute_id: [number] | null = null): boolean {
