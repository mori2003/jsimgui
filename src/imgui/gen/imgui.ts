 ...
 */
export const ImGuiInputTextFlags = {
	/**
 ...
 */
export const ImGuiTreeNodeFlags = {
	None: 0,
	/**
	 * Draw as selected
	 */
	...
	// mGuiTreeNodeFlags_NoScrollOnOpen     = 1 << 16,  // FIXME: TODO: Disable automatic scroll on TreePop() if node got just open and contents is not visible
...
export const ImGuiPopupFlags = {
	...
	// mGuiPopupFlags_NoReopenAlwaysNavInit = 1 << 6,   // For OpenPopup*(), BeginPopupContext*(): focus and initialize navigation even when not reopening.
 ...
 */
export const ImGuiSelectableFlags = {
	None: 0,
	/**
 ...
 */
export const ImGuiTabItemFlags = {
	None: 0,
	/**
 ...
 */
export const ImGuiFocusedFlags = {
	None: 0,
	/**
 ...
 */
export const ImGuiHoveredFlags = {
	/**
	...
	// mGuiHoveredFlags_AllowWhenBlockedByModal     = 1 << 6,   // Return true even if a modal popup window is normally blocking access to this item/window. FIXME-TODO: Unavailable yet.
...
export const ImGuiDockNodeFlags = {
	...
	// mGuiDockNodeFlags_NoCentralNode              = 1 << 1,   //       // Disable Central Node (the node which can stay empty)
 ...
 */
export const ImGuiDragDropFlags = {
	None: 0,
 ...
 */
export const ImGuiSortDirection = {
	_None: 0,
	/**
 ...
 */
export const ImGuiBackendFlags = {
	None: 0,
	/**
 ...
 */
export const ImGuiColorEditFlags = {
	None: 0,
	/**
 ...
 */
export const ImGuiTableColumnFlags = {
	/**
 ...
 */
export const ImGuiTableRowFlags = {
	None: 0,
	/**
 ...
 */
export const ImGuiTableBgTarget = {
	None: 0,
	/**
 ...
 */
export const ImGuiListClipperFlags = {
	None: 0,
	/**
 ...
 */
export const ImGuiMultiSelectFlags = {
	None: 0,
	/**
	...
	// mGuiMultiSelectFlags_RangeSelect2d       = 1 << 15,  // Shift+Selection uses 2d geometry instead of linear sequence, so possible to use Shift+up/down to select vertically in grid. Analogous to what BoxSelect does.
 ...
 */
export const ImGuiSelectionRequestType = {
	_None: 0,
	/**
 ...
 */
export const ImGuiViewportFlags = {
	None: 0,
	/**
...
export class ImFontConfig extends ReferenceStruct {
	...
	// mVec2        GlyphExtraSpacing;      // 0, 0     // (REMOVED AT IT SEEMS LARGELY OBSOLETE. PLEASE REPORT IF YOU WERE USING THIS). Extra spacing (in pixels) between glyphs when rendered: essentially add to glyph->AdvanceX. Only X axis is supported for now.
	...
	// nsigned int  FontBuilderFlags;       // --       // [Renamed in 1.92] Use FontLoaderFlags.
...
export class ImGui {
	 ...
	 */
	static CreateContext(shared_font_atlas: ImFontAtlas | null = null): ImGuiContext {
		return ImGuiContext.From(Mod.export.ImGui_CreateContext(shared_font_atlas?.ptr ?? null));
	}
	/**
	 * NULL = destroy current context
	 */
	static DestroyContext(ctx: ImGuiContext | null = null): void {
	 ...
	 */
	static ShowMetricsWindow(p_open: [boolean] | null = null): void {
		Mod.export.ImGui_ShowMetricsWindow(p_open);
	}
	/**
	 * create Debug Log window. display a simplified log of important dear imgui events.
	 */
	static ShowDebugLogWindow(p_open: [boolean] | null = null): void {
		Mod.export.ImGui_ShowDebugLogWindow(p_open);
	}
	/**
	 * create Stack Tool window. hover items with mouse to query information about the source of their unique ID.
	 */
	static ShowIDStackToolWindow(p_open: [boolean] | null = null): void {
		Mod.export.ImGui_ShowIDStackToolWindow(p_open);
	}
	/**
	 * create About window. display Dear ImGui version, credits and build/system information.
	 */
	static ShowAboutWindow(p_open: [boolean] | null = null): void {
		Mod.export.ImGui_ShowAboutWindow(p_open);
	}
	/**
	 * add style editor block (not a window). you can pass in a reference ImGuiStyle structure to compare to, revert to and save to (else it uses the default style)
	 */
	static ShowStyleEditor(ref: ImGuiStyle | null = null): void {
	 ...
	 */
	static StyleColorsDark(dst: ImGuiStyle | null = null): void {
		Mod.export.ImGui_StyleColorsDark(dst?.ptr ?? null);
	}
	/**
	 * best used with borders and a custom, thicker font
	 */
	static StyleColorsLight(dst: ImGuiStyle | null = null): void {
		Mod.export.ImGui_StyleColorsLight(dst?.ptr ?? null);
	}
	/**
	 * classic imgui style
	 */
	static StyleColorsClassic(dst: ImGuiStyle | null = null): void {
	 ...
	 */
	static IsWindowFocused(flags: ImGuiFocusedFlags = 0): boolean {
	 ...
	 */
	static IsWindowHovered(flags: ImGuiHoveredFlags = 0): boolean {
	 ...
	 */
	static SetNextWindowPos(
		pos: ImVec2,
		cond: ImGuiCond = 0,
		pivot: ImVec2 = new ImVec2(0, 0),
	): void {
	 ...
	 */
	static SetNextWindowSize(size: ImVec2, cond: ImGuiCond = 0): void {
	 ...
	 */
	static SetNextWindowCollapsed(collapsed: boolean, cond: ImGuiCond = 0): void {
	 ...
	 */
	static SetWindowPos(pos: ImVec2, cond: ImGuiCond = 0): void {
		Mod.export.ImGui_SetWindowPos(pos, cond);
	}
	/**
	 * (not recommended) set current window size - call within Begin()/End(). set to ImVec2(0, 0) to force an auto-fit. prefer using SetNextWindowSize(), as this may incur tearing and minor side-effects.
	 */
	static SetWindowSize(size: ImVec2, cond: ImGuiCond = 0): void {
		Mod.export.ImGui_SetWindowSize(size, cond);
	}
	/**
	 * (not recommended) set current window collapsed state. prefer using SetNextWindowCollapsed().
	 */
	static SetWindowCollapsed(collapsed: boolean, cond: ImGuiCond = 0): void {
	 ...
	 */
	static SetWindowPosStr(name: string, pos: ImVec2, cond: ImGuiCond = 0): void {
		Mod.export.ImGui_SetWindowPosStr(name, pos, cond);
	}
	/**
	 * set named window size. set axis to 0.0f to force an auto-fit on this axis.
	 */
	static SetWindowSizeStr(name: string, size: ImVec2, cond: ImGuiCond = 0): void {
		Mod.export.ImGui_SetWindowSizeStr(name, size, cond);
	}
	/**
	 * set named window collapsed state
	 */
	static SetWindowCollapsedStr(name: string, collapsed: boolean, cond: ImGuiCond = 0): void {
	 ...
	 */
	static SetScrollHereX(center_x_ratio: number = 0.5): void {
		Mod.export.ImGui_SetScrollHereX(center_x_ratio);
	}
	/**
	 * adjust scrolling amount to make current cursor position visible. center_y_ratio=0.0: top, 0.5: center, 1.0: bottom. When using to make a "default/current item" visible, consider using SetItemDefaultFocus() instead.
	 */
	static SetScrollHereY(center_y_ratio: number = 0.5): void {
		Mod.export.ImGui_SetScrollHereY(center_y_ratio);
	}
	/**
	 * adjust scrolling amount to make given position visible. Generally GetCursorStartPos() + offset to compute a valid position.
	 */
	static SetScrollFromPosX(local_x: number, center_x_ratio: number = 0.5): void {
		Mod.export.ImGui_SetScrollFromPosX(local_x, center_x_ratio);
	}
	/**
	 * adjust scrolling amount to make given position visible. Generally GetCursorStartPos() + offset to compute a valid position.
	 */
	static SetScrollFromPosY(local_y: number, center_y_ratio: number = 0.5): void {
	 ...
	 */
	static PushTextWrapPos(wrap_local_pos_x: number = 0.0): void {
	 ...
	 */
	static GetColorU32(idx: ImGuiCol, alpha_mul: number = 1.0): ImU32 {
	 ...
	 * retrieve given color with style alpha applied, packed as a 32-bit value suitable for ImDrawList
	 */
	static GetColorU32ImU32(col: ImU32, alpha_mul: number = 1.0): ImU32 {
	 ...
	 */
	static SameLine(offset_from_start_x: number = 0.0, spacing: number = -1.0): void {
	 ...
	 */
	static Indent(indent_w: number = 0.0): void {
		Mod.export.ImGui_Indent(indent_w);
	}
	/**
	 * move content position back to the left, by indent_w, or style.IndentSpacing if indent_w <= 0
	 */
	static Unindent(indent_w: number = 0.0): void {
	 ...
	 * button
	 */
	static Button(label: string, size: ImVec2 = new ImVec2(0, 0)): boolean {
	 ...
	 */
	static InvisibleButton(str_id: string, size: ImVec2, flags: ImGuiButtonFlags = 0): boolean {
	 ...
	 */
	static BeginCombo(label: string, preview_value: string, flags: ImGuiComboFlags = 0): boolean {
	...
	static InputInt2(label: string, v: [number, number], flags: ImGuiInputTextFlags = 0): boolean {
	...
	static TreeNodeEx(label: string, flags: ImGuiTreeNodeFlags = 0): boolean {
	 ...
	 */
	static CollapsingHeader(label: string, flags: ImGuiTreeNodeFlags = 0): boolean {
		return Mod.export.ImGui_CollapsingHeader(label, flags);
	}
	/**
	 * when 'p_visible != NULL': if '*p_visible==true' display an additional small close button on upper right of the header which will set the bool to false when clicked, if '*p_visible==false' don't display the header.
	 */
	static CollapsingHeaderBoolPtr(
		label: string,
		p_visible: [boolean],
	 ...
	 */
	static SetNextItemOpen(is_open: boolean, cond: ImGuiCond = 0): void {
	 ...
	 */
	static BeginListBox(label: string, size: ImVec2 = new ImVec2(0, 0)): boolean {
	 ...
	 */
	static BeginMenu(label: string, enabled: boolean = true): boolean {
	 ...
	 */
	static BeginPopup(str_id: string, flags: ImGuiWindowFlags = 0): boolean {
		return Mod.export.ImGui_BeginPopup(str_id, flags);
	}
	/**
	 * return true if the modal is open, and you can start outputting to it.
	 */
	static BeginPopupModal(
		name: string,
		p_open: [boolean] | null = null,
		flags: ImGuiWindowFlags = 0,
	): boolean {
	 ...
	 */
	static OpenPopup(str_id: string, popup_flags: ImGuiPopupFlags = 0): void {
		Mod.export.ImGui_OpenPopup(str_id, popup_flags);
	}
	/**
	 * id overload to facilitate calling from nested stacks
	 */
	static OpenPopupID(id: ImGuiID, popup_flags: ImGuiPopupFlags = 0): void {
		Mod.export.ImGui_OpenPopupID(id, popup_flags);
	}
	/**
	 * helper to open popup when clicked on last item. Default to ImGuiPopupFlags_MouseButtonRight == 1. (note: actually triggers on the mouse _released_ event to be consistent with popup behaviors)
	 */
	static OpenPopupOnItemClick(str_id: string = "", popup_flags: ImGuiPopupFlags = 0): void {
	 ...
	 */
	static BeginPopupContextItem(str_id: string = "", popup_flags: ImGuiPopupFlags = 0): boolean {
		return Mod.export.ImGui_BeginPopupContextItem(str_id, popup_flags);
	}
	/**
	 * open+begin popup when clicked on current window.
	 */
	static BeginPopupContextWindow(str_id: string = "", popup_flags: ImGuiPopupFlags = 0): boolean {
		return Mod.export.ImGui_BeginPopupContextWindow(str_id, popup_flags);
	}
	/**
	 * open+begin popup when clicked in void (where there are no windows).
	 */
	static BeginPopupContextVoid(str_id: string = "", popup_flags: ImGuiPopupFlags = 0): boolean {
	 ...
	 */
	static IsPopupOpen(str_id: string, flags: ImGuiPopupFlags = 0): boolean {
	 ...
	 */
	static TableNextRow(row_flags: ImGuiTableRowFlags = 0, min_row_height: number = 0.0): void {
	 ...
	 */
	static TableGetColumnName(column_n: number = -1): string {
		return Mod.export.ImGui_TableGetColumnName(column_n);
	}
	/**
	 * return column flags so you can query their Enabled/Visible/Sorted/Hovered status flags. Pass -1 to use current column.
	 */
	static TableGetColumnFlags(column_n: number = -1): ImGuiTableColumnFlags {
	 ...
	 */
	static TableSetBgColor(target: ImGuiTableBgTarget, color: ImU32, column_n: number = -1): void {
	 ...
	 */
	static Columns(count: number = 1, id: string = "", borders: boolean = true): void {
	 ...
	 */
	static GetColumnWidth(column_index: number = -1): number {
	 ...
	 */
	static GetColumnOffset(column_index: number = -1): number {
	 ...
	 */
	static BeginTabBar(str_id: string, flags: ImGuiTabBarFlags = 0): boolean {
	 ...
	 */
	static TabItemButton(label: string, flags: ImGuiTabItemFlags = 0): boolean {
	 ...
	 */
	static SetNextWindowDockID(dock_id: ImGuiID, cond: ImGuiCond = 0): void {
	 ...
	 */
	static LogToTTY(auto_open_depth: number = -1): void {
		Mod.export.ImGui_LogToTTY(auto_open_depth);
	}
	/**
	 * start logging to file
	 */
	static LogToFile(auto_open_depth: number = -1, filename: string = ""): void {
		Mod.export.ImGui_LogToFile(auto_open_depth, filename);
	}
	/**
	 * start logging to OS clipboard
	 */
	static LogToClipboard(auto_open_depth: number = -1): void {
	 ...
	 */
	static BeginDragDropSource(flags: ImGuiDragDropFlags = 0): boolean {
	 ...
	 */
	static AcceptDragDropPayload(type: string, flags: ImGuiDragDropFlags = 0): ImGuiPayload {
	 ...
	 */
	static BeginDisabled(disabled: boolean = true): void {
	 ...
	 */
	static SetKeyboardFocusHere(offset: number = 0): void {
	 ...
	 */
	static IsItemHovered(flags: ImGuiHoveredFlags = 0): boolean {
	 ...
	 */
	static IsItemClicked(mouse_button: ImGuiMouseButton = 0): boolean {
	 ...
	 */
	static GetBackgroundDrawList(viewport: ImGuiViewport | null = null): ImDrawList {
	 ...
	 */
	static GetForegroundDrawList(viewport: ImGuiViewport | null = null): ImDrawList {
	 ...
	 */
	static IsKeyPressed(key: ImGuiKey, repeat: boolean = true): boolean {
	 ...
	 */
	static Shortcut(key_chord: ImGuiKeyChord, flags: ImGuiInputFlags = 0): boolean {
		return Mod.export.ImGui_Shortcut(key_chord, flags);
	}
	static SetNextItemShortcut(key_chord: ImGuiKeyChord, flags: ImGuiInputFlags = 0): void {
	 ...
	 */
	static IsMouseClicked(button: ImGuiMouseButton, repeat: boolean = false): boolean {
	 ...
	 */
	static IsMouseHoveringRect(r_min: ImVec2, r_max: ImVec2, clip: boolean = true): boolean {
		return Mod.export.ImGui_IsMouseHoveringRect(r_min, r_max, clip);
	}
	/**
	 * by convention we use (-FLT_MAX,-FLT_MAX) to denote that there is no mouse available
	 */
	static IsMousePosValid(mouse_pos: ImVec2 | null = null): boolean {
	 ...
	 */
	static IsMouseDragging(button: ImGuiMouseButton, lock_threshold: number = -1.0): boolean {
		return Mod.export.ImGui_IsMouseDragging(button, lock_threshold);
	}
	/**
	 * return the delta from the initial clicking position while the mouse button is pressed or was just released. This is locked and return 0.0f until the mouse moves past a distance threshold at least once (uses io.MouseDraggingThreshold if lock_threshold < 0.0f)
	 */
	static GetMouseDragDelta(button: ImGuiMouseButton = 0, lock_threshold: number = -1.0): ImVec2 {
		return ImVec2.From(Mod.export.ImGui_GetMouseDragDelta(button, lock_threshold));
	}
	/**
	 *
	 */
	static ResetMouseDragDelta(button: ImGuiMouseButton = 0): void {
	 ...
	 */
	static LoadIniSettingsFromMemory(ini_data: string, ini_size: number = 0): void {
		Mod.export.ImGui_LoadIniSettingsFromMemory(ini_data, ini_size);
	}
	/**
	 * return a zero-terminated string with the .ini data which you can save by your own mean. call when io.WantSaveIniSettings is set, then save data by your own mean and clear io.WantSaveIniSettings.
	 */
	static SaveIniSettingsToMemory(out_ini_size: [number] | null = null): string {
	 ...
	 */
	static DebugCheckVersionAndDataLayout(
		version_str: string,
		sz_io: number,
		sz_style: number,
		sz_vec2: number,
	 ...
	 */
	static RenderPlatformWindowsDefault(
