 ...
 */
SetKeyEventNativeData(key: ImGuiKey, native_keycode: number, native_scancode: number, native_legacy_index: number = -1): void {
 ...
 */
PushClipRect(clip_rect_min: ImVec2, clip_rect_max: ImVec2, intersect_with_current_clip_rect: boolean = false): void {
 ...
 */
AddRect(p_min: ImVec2, p_max: ImVec2, col: ImU32, rounding: number = 0.0, flags: ImDrawFlags = 0, thickness: number = 1.0): void {
 ...
 * \/\/ a: upper-left, b: lower-right (== upper-left + size)
 */
AddRectFilled(p_min: ImVec2, p_max: ImVec2, col: ImU32, rounding: number = 0.0, flags: ImDrawFlags = 0): void {
...
AddQuad(p1: ImVec2, p2: ImVec2, p3: ImVec2, p4: ImVec2, col: ImU32, thickness: number = 1.0): void {
...
AddCircle(center: ImVec2, radius: number, col: ImU32, num_segments: number = 0, thickness: number = 1.0): void {
...
AddNgon(center: ImVec2, radius: number, col: ImU32, num_segments: number, thickness: number = 1.0): void {
...
AddEllipse(center: ImVec2, radius: ImVec2, col: ImU32, rot: number = 0.0, num_segments: number = 0, thickness: number = 1.0): void {
        this.ptr.ImDrawList_AddEllipse(center, radius, col, rot, num_segments, thickness);

}
AddEllipseFilled(center: ImVec2, radius: ImVec2, col: ImU32, rot: number = 0.0, num_segments: number = 0): void {
...
AddTextImFontPtr(font: ImFont, font_size: number, pos: ImVec2, col: ImU32, text_begin: string, text_end: string = "", wrap_width: number = 0.0, cpu_fine_clip_rect: ImVec4 | null = null): void {
 ...
 */
AddBezierCubic(p1: ImVec2, p2: ImVec2, p3: ImVec2, p4: ImVec2, col: ImU32, thickness: number, num_segments: number = 0): void {
 ...
 */
AddBezierQuadratic(p1: ImVec2, p2: ImVec2, p3: ImVec2, col: ImU32, thickness: number, num_segments: number = 0): void {
 ...
 */
AddImage(tex_ref: ImTextureRef, p_min: ImVec2, p_max: ImVec2, uv_min: ImVec2 = new ImVec2(0, 0), uv_max: ImVec2 = new ImVec2(1, 1), col: ImU32 = IM_COL32_WHITE): void {
        this.ptr.ImDrawList_AddImage(tex_ref, p_min, p_max, uv_min, uv_max, col);

}
AddImageQuad(tex_ref: ImTextureRef, p1: ImVec2, p2: ImVec2, p3: ImVec2, p4: ImVec2, uv1: ImVec2 = new ImVec2(0, 0), uv2: ImVec2 = new ImVec2(1, 0), uv3: ImVec2 = new ImVec2(1, 1), uv4: ImVec2 = new ImVec2(0, 1), col: ImU32 = IM_COL32_WHITE): void {
        this.ptr.ImDrawList_AddImageQuad(tex_ref, p1, p2, p3, p4, uv1, uv2, uv3, uv4, col);

}
AddImageRounded(tex_ref: ImTextureRef, p_min: ImVec2, p_max: ImVec2, uv_min: ImVec2, uv_max: ImVec2, col: ImU32, rounding: number, flags: ImDrawFlags = 0): void {
...
PathArcTo(center: ImVec2, radius: number, a_min: number, a_max: number, num_segments: number = 0): void {
 ...
 * \/\/ Ellipse
 */
PathEllipticalArcTo(center: ImVec2, radius: ImVec2, rot: number, a_min: number, a_max: number, num_segments: number = 0): void {
...
PathRect(rect_min: ImVec2, rect_max: ImVec2, rounding: number = 0.0, flags: ImDrawFlags = 0): void {
...
AddFontDefaultBitmap(font_cfg: ImFontConfig | null = null): ImFont {
    ...
    AddFontFromFileTTF(filename: string, size_pixels: number = 0.0, font_cfg: ImFontConfig | null = null, glyph_ranges: ImWchar[] | null = null): ImFont {
 ...
 */
AddCustomRect(width: number, height: number, out_r: ImFontAtlasRect | null = null): ImFontAtlasRectId {
 ...
 * \/\/    BeginXXX function returned true. Begin and BeginChild are the only odd ones out. Will be fixed in a future update.]
 */
BeginChild(str_id: string, size: ImVec2 = new ImVec2(0, 0), child_flags: ImGuiChildFlags = 0, window_flags: ImGuiWindowFlags = 0): boolean {
        return Mod.export.ImGui_BeginChild(str_id, size, child_flags, window_flags);

},
BeginChildID(id: ImGuiID, size: ImVec2 = new ImVec2(0, 0), child_flags: ImGuiChildFlags = 0, window_flags: ImGuiWindowFlags = 0): boolean {
...
ProgressBar(fraction: number, size_arg: ImVec2 = new ImVec2(-Number.MIN_VALUE, 0), overlay: string = ""): void {
 ...
 */
Image(tex_ref: ImTextureRef, image_size: ImVec2, uv0: ImVec2 = new ImVec2(0, 0), uv1: ImVec2 = new ImVec2(1, 1)): void {
        Mod.export.ImGui_Image(tex_ref, image_size, uv0, uv1);

},
ImageWithBg(tex_ref: ImTextureRef, image_size: ImVec2, uv0: ImVec2 = new ImVec2(0, 0), uv1: ImVec2 = new ImVec2(1, 1), bg_col: ImVec4 = new ImVec4(0, 0, 0, 0), tint_col: ImVec4 = new ImVec4(1, 1, 1, 1)): void {
        Mod.export.ImGui_ImageWithBg(tex_ref, image_size, uv0, uv1, bg_col, tint_col);

},
ImageButton(str_id: string, tex_ref: ImTextureRef, image_size: ImVec2, uv0: ImVec2 = new ImVec2(0, 0), uv1: ImVec2 = new ImVec2(1, 1), bg_col: ImVec4 = new ImVec4(0, 0, 0, 0), tint_col: ImVec4 = new ImVec4(1, 1, 1, 1)): boolean {
 ...
 */
Combo(label: string, current_item: [number], items_separated_by_zeros: string, popup_max_height_in_items: number = -1): boolean {
 ...
 */
DragFloat(label: string, v: [number], v_speed: number = 1.0, v_min: number = 0.0, v_max: number = 0.0, format: string = "%.3f", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_DragFloat(label, v, v_speed, v_min, v_max, format, flags);

},
DragFloat2(label: string, v: [number, number], v_speed: number = 1.0, v_min: number = 0.0, v_max: number = 0.0, format: string = "%.3f", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_DragFloat2(label, v, v_speed, v_min, v_max, format, flags);

},
DragFloat3(label: string, v: [number, number, number], v_speed: number = 1.0, v_min: number = 0.0, v_max: number = 0.0, format: string = "%.3f", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_DragFloat3(label, v, v_speed, v_min, v_max, format, flags);

},
DragFloat4(label: string, v: [number, number, number, number], v_speed: number = 1.0, v_min: number = 0.0, v_max: number = 0.0, format: string = "%.3f", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_DragFloat4(label, v, v_speed, v_min, v_max, format, flags);

},
DragFloatRange2(label: string, v_current_min: [number], v_current_max: [number], v_speed: number = 1.0, v_min: number = 0.0, v_max: number = 0.0, format: string = "%.3f", format_max: string = "", flags: ImGuiSliderFlags = 0): boolean {
 ...
 * \/\/ If v_min >= v_max we have no bound
 */
DragInt(label: string, v: [number], v_speed: number = 1.0, v_min: number = 0, v_max: number = 0, format: string = "%d", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_DragInt(label, v, v_speed, v_min, v_max, format, flags);

},
DragInt2(label: string, v: [number, number], v_speed: number = 1.0, v_min: number = 0, v_max: number = 0, format: string = "%d", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_DragInt2(label, v, v_speed, v_min, v_max, format, flags);

},
DragInt3(label: string, v: [number, number, number], v_speed: number = 1.0, v_min: number = 0, v_max: number = 0, format: string = "%d", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_DragInt3(label, v, v_speed, v_min, v_max, format, flags);

},
DragInt4(label: string, v: [number, number, number, number], v_speed: number = 1.0, v_min: number = 0, v_max: number = 0, format: string = "%d", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_DragInt4(label, v, v_speed, v_min, v_max, format, flags);

},
DragIntRange2(label: string, v_current_min: [number], v_current_max: [number], v_speed: number = 1.0, v_min: number = 0, v_max: number = 0, format: string = "%d", format_max: string = "", flags: ImGuiSliderFlags = 0): boolean {
 ...
 */
SliderFloat(label: string, v: [number], v_min: number, v_max: number, format: string = "%.3f", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_SliderFloat(label, v, v_min, v_max, format, flags);

},
SliderFloat2(label: string, v: [number, number], v_min: number, v_max: number, format: string = "%.3f", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_SliderFloat2(label, v, v_min, v_max, format, flags);

},
SliderFloat3(label: string, v: [number, number, number], v_min: number, v_max: number, format: string = "%.3f", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_SliderFloat3(label, v, v_min, v_max, format, flags);

},
SliderFloat4(label: string, v: [number, number, number, number], v_min: number, v_max: number, format: string = "%.3f", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_SliderFloat4(label, v, v_min, v_max, format, flags);

},
SliderAngle(label: string, v_rad: [number], v_degrees_min: number = -360.0, v_degrees_max: number = +360.0, format: string = "%.0f deg", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_SliderAngle(label, v_rad, v_degrees_min, v_degrees_max, format, flags);

},
SliderInt(label: string, v: [number], v_min: number, v_max: number, format: string = "%d", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_SliderInt(label, v, v_min, v_max, format, flags);

},
SliderInt2(label: string, v: [number, number], v_min: number, v_max: number, format: string = "%d", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_SliderInt2(label, v, v_min, v_max, format, flags);

},
SliderInt3(label: string, v: [number, number, number], v_min: number, v_max: number, format: string = "%d", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_SliderInt3(label, v, v_min, v_max, format, flags);

},
SliderInt4(label: string, v: [number, number, number, number], v_min: number, v_max: number, format: string = "%d", flags: ImGuiSliderFlags = 0): boolean {
        return Mod.export.ImGui_SliderInt4(label, v, v_min, v_max, format, flags);

},
    InputText(label: string, buf: [string], buf_size: number, flags: ImGuiInputTextFlags = 0): boolean {
        return Mod.export.ImGui_InputText(label, buf, buf_size, flags);
    },
    InputTextMultiline(label: string, buf: [string], buf_size: number, size: ImVec2 = new ImVec2(0, 0), flags: ImGuiInputTextFlags = 0): boolean {
        return Mod.export.ImGui_InputTextMultiline(label, buf, buf_size, size, flags);
    },
    InputTextWithHint(label: string, hint: string, buf: [string], buf_size: number, flags: ImGuiInputTextFlags = 0): boolean {
        return Mod.export.ImGui_InputTextWithHint(label, hint, buf, buf_size, flags);
    },
InputFloat(label: string, v: [number], step: number = 0.0, step_fast: number = 0.0, format: string = "%.3f", flags: ImGuiInputTextFlags = 0): boolean {
        return Mod.export.ImGui_InputFloat(label, v, step, step_fast, format, flags);

},
InputFloat2(label: string, v: [number, number], format: string = "%.3f", flags: ImGuiInputTextFlags = 0): boolean {
        return Mod.export.ImGui_InputFloat2(label, v, format, flags);

},
InputFloat3(label: string, v: [number, number, number], format: string = "%.3f", flags: ImGuiInputTextFlags = 0): boolean {
        return Mod.export.ImGui_InputFloat3(label, v, format, flags);

},
InputFloat4(label: string, v: [number, number, number, number], format: string = "%.3f", flags: ImGuiInputTextFlags = 0): boolean {
        return Mod.export.ImGui_InputFloat4(label, v, format, flags);

},
InputInt(label: string, v: [number], step: number = 1, step_fast: number = 100, flags: ImGuiInputTextFlags = 0): boolean {
...
InputInt4(label: string, v: [number, number, number, number], flags: ImGuiInputTextFlags = 0): boolean {
        return Mod.export.ImGui_InputInt4(label, v, flags);

},
InputDouble(label: string, v: [number], step: number = 0.0, step_fast: number = 0.0, format: string = "%.6f", flags: ImGuiInputTextFlags = 0): boolean {
 ...
 */
ColorEdit3(label: string, col: [number, number, number], flags: ImGuiColorEditFlags = 0): boolean {
        return Mod.export.ImGui_ColorEdit3(label, col, flags);

},
ColorEdit4(label: string, col: [number, number, number, number], flags: ImGuiColorEditFlags = 0): boolean {
        return Mod.export.ImGui_ColorEdit4(label, col, flags);

},
ColorPicker3(label: string, col: [number, number, number], flags: ImGuiColorEditFlags = 0): boolean {
        return Mod.export.ImGui_ColorPicker3(label, col, flags);

},
ColorPicker4(label: string, col: [number, number, number, number], flags: ImGuiColorEditFlags = 0, ref_col: number[] | null = null): boolean {
 ...
 */
ColorButton(desc_id: string, col: ImVec4, flags: ImGuiColorEditFlags = 0, size: ImVec2 = new ImVec2(0, 0)): boolean {
 ...
 */
CollapsingHeaderBoolPtr(label: string, p_visible: [boolean], flags: ImGuiTreeNodeFlags = 0): boolean {
 ...
 */
Selectable(label: string, selected: boolean = false, flags: ImGuiSelectableFlags = 0, size: ImVec2 = new ImVec2(0, 0)): boolean {
 ...
 */
SelectableBoolPtr(label: string, p_selected: [boolean], flags: ImGuiSelectableFlags = 0, size: ImVec2 = new ImVec2(0, 0)): boolean {
 ...
 */
BeginMultiSelect(flags: ImGuiMultiSelectFlags, selection_size: number = -1, items_count: number = -1): ImGuiMultiSelectIO {
 ...
 */
PlotLines(label: string, values: number[], values_count: number, values_offset: number = 0, overlay_text: string = "", scale_min: number = Number.MAX_VALUE, scale_max: number = Number.MAX_VALUE, graph_size: ImVec2 = new ImVec2(0, 0), stride: number = 4): void {
        Mod.export.ImGui_PlotLines(label, values, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size, stride);

},
PlotHistogram(label: string, values: number[], values_count: number, values_offset: number = 0, overlay_text: string = "", scale_min: number = Number.MAX_VALUE, scale_max: number = Number.MAX_VALUE, graph_size: ImVec2 = new ImVec2(0, 0), stride: number = 4): void {
 ...
 */
MenuItem(label: string, shortcut: string = "", selected: boolean = false, enabled: boolean = true): boolean {
 ...
 */
MenuItemBoolPtr(label: string, shortcut: string, p_selected: [boolean], enabled: boolean = true): boolean {
 ...
 */
BeginPopupModal(name: string, p_open: [boolean] | null = null, flags: ImGuiWindowFlags = 0): boolean {
 ...
 * \/\/ - 5. Call EndTable()
 */
BeginTable(str_id: string, columns: number, flags: ImGuiTableFlags = 0, outer_size: ImVec2 = new ImVec2(0.0, 0.0), inner_width: number = 0.0): boolean {
 ...
 */
TableSetupColumn(label: string, flags: ImGuiTableColumnFlags = 0, init_width_or_weight: number = 0.0, user_id: ImGuiID = 0): void {
 ...
 */
BeginTabItem(label: string, p_open: [boolean] | null = null, flags: ImGuiTabItemFlags = 0): boolean {
 ...
 */
DockSpace(dockspace_id: ImGuiID, size: ImVec2 = new ImVec2(0, 0), flags: ImGuiDockNodeFlags = 0, window_class: ImGuiWindowClass | null = null): ImGuiID {
        return Mod.export.ImGui_DockSpace(dockspace_id, size, flags, window_class?.ptr ?? null);

},
DockSpaceOverViewport(dockspace_id: ImGuiID = 0, viewport: ImGuiViewport | null = null, flags: ImGuiDockNodeFlags = 0, window_class: ImGuiWindowClass | null = null): ImGuiID {
 ...
 * \/\/ Text Utilities
 */
CalcTextSize(text: string, text_end: string = "", hide_text_after_double_hash: boolean = false, wrap_width: number = -1.0): ImVec2 {
 ...
 */
RenderPlatformWindowsDefault(platform_render_arg: any | null = null, renderer_render_arg: any | null = null): void {
