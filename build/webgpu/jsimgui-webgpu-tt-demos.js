var MainExport = (() => {
    return async function (moduleArg = {}) {
        ...
        function findWasmBinary() {
            if (Module["locateFile"]) {
                return locateFile("jsimgui-webgpu-tt-demos.wasm");
            }
            return new URL("jsimgui-webgpu-tt-demos.wasm", import.meta.url).href;
        }
        ...
        var wasmImports = {
            ...
            y: _emscripten_webgpu_import_render_pass_encoder,
            K: _environ_get,
            ...
            G: _fd_write,
            A: _proc_exit,
            T: _wgpuBindGroupLayoutRelease,
            Z: _wgpuBindGroupRelease,
            w: _wgpuBufferDestroy,
            n: _wgpuBufferRelease,
            t: _wgpuDeviceCreateBindGroup,
            u: _wgpuDeviceCreateBindGroupLayout,
            m: _wgpuDeviceCreateBuffer,
            ha: _wgpuDeviceCreatePipelineLayout,
            ga: _wgpuDeviceCreateRenderPipeline,
            fa: _wgpuDeviceCreateSampler,
            W: _wgpuDeviceCreateShaderModule,
            la: _wgpuDeviceCreateTexture,
            ea: _wgpuDeviceGetQueue,
            U: _wgpuPipelineLayoutRelease,
            da: _wgpuQueueRelease,
            j: _wgpuQueueWriteBuffer,
            ja: _wgpuQueueWriteTexture,
            ma: _wgpuRenderPassEncoderDrawIndexed,
            v: _wgpuRenderPassEncoderSetBindGroup,
            _: _wgpuRenderPassEncoderSetBlendConstant,
            aa: _wgpuRenderPassEncoderSetIndexBuffer,
            $: _wgpuRenderPassEncoderSetPipeline,
            na: _wgpuRenderPassEncoderSetScissorRect,
            ba: _wgpuRenderPassEncoderSetVertexBuffer,
            ca: _wgpuRenderPassEncoderSetViewport,
            S: _wgpuRenderPipelineRelease,
            R: _wgpuSamplerRelease,
            V: _wgpuShaderModuleRelease,
            ka: _wgpuTextureCreateView,
            X: _wgpuTextureRelease,
            Y: _wgpuTextureViewRelease,
        };
        var wasmExports = await createWasm();
        var ___wasm_call_ctors = wasmExports["ua"];
        var _emscripten_stack_get_current = wasmExports["va"];
        var _malloc = wasmExports["wa"];
        var _free = wasmExports["xa"];
        var ___getTypeName = wasmExports["ya"];
        var __emscripten_timeout = wasmExports["Aa"];
        var __emscripten_stack_restore = wasmExports["Ba"];
        var __emscripten_stack_alloc = wasmExports["Ca"];
        function run() {
            if (runDependencies > 0) {
