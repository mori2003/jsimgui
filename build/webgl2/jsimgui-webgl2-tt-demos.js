var MainExport = (() => {
    return async function (moduleArg = {}) {
        ...
        var wasmImports = {
            ...
            V: __emscripten_runtime_keepalive_clear,
            r: __emval_as,
            Ia: __emval_decref,
        ...
        var _malloc = wasmExports["La"];
        var _free = wasmExports["Ma"];
        var ___getTypeName = wasmExports["Na"];
        var __emscripten_timeout = wasmExports["Pa"];
        function run() {
            if (runDependencies > 0) {
