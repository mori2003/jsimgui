...
export const ImGui = {
    ...
    /** [Auto] */
    ImageButton: (str_id, user_texture_id, image_size, uv0 = new ImVec2(0, 0), uv1 = new ImVec2(1, 1), bg_col = new ImVec4(0, 0, 0, 0), tint_col = new ImVec4(1, 1, 1, 1)) => { return Mod.main.ImGui_ImageButtonEx(str_id, user_texture_id, image_size.unwrap(), uv0.unwrap(), uv1.unwrap(), bg_col.unwrap(), tint_col.unwrap()) },
    /** [Auto] */
    ...
    /** [Auto] */
    Combo: (label, current_item, items_separated_by_zeros, popup_max_height_in_items = -1) => { return Mod.main.ImGui_ComboEx(label, current_item, items_separated_by_zeros, popup_max_height_in_items) },
    /** [Auto] */
